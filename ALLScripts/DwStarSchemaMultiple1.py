    ...
    try:
        ...
        if connection.is_connected():
            ...
            for coid in res:
                ...
                insertmultiple = "Insert into DWStarSchemaMultiple1 (DWID, PeriodID, ReportedDateID, Value, DWCoID)\
Select DWID, PeriodID, ReportedDateID, Value*%s, %s From DWStarSchema where DWCoID = 9"%(str(mult),str(coid[0]))
