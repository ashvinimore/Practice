    ...
    try:
        ...
        if connection.is_connected():
                    ...
                    if (gxbrlid != 0 or gxbrlid != 'None'):
                        ...
                        if (GICSID == 0):
                            ...
                            if str(GICSvalue).isdigit() != True:
                                ...
                                GICSvalue = '=' + str(sheet.cell(row=rowall, column=GICSID).value)
                                try:
                                    gicsid = "select DWGroupID from DWGroups where GroupRefID {}".format(GICSvalue)
            ...
            #                             #
                                                            if periodid:
                                                                try:
                                                                    searchQuery = "select DWID from DWStarSchemaExtract where DWID = %s and PeriodID = %s and ReportedDateID = %s and DWCoID = %s"
                                                                    ...
                                                                    if serachdwhid:
                                                                        print("serachdwhid",serachdwhid)
                                                                            ...
                                                                            insertQuery = "insert into DWStarSchemaExtract(DWID,PeriodID,ReportedDateID,Value,DWCoID) values(" \
                                                                                          "'%s','%s','%s','%s','%s')" % (
...
def dumpUIDSchema():
    try:
        ...
        if connection.is_connected():
            ...
            # cursor.execute(sqlquery)
            file_name = '/home/pavan/Music/DataWarehouse/DWH-1.xlsx'
            wb = load_workbook('/home/pavan/Music/DataWarehouse/DCExcelSheets/DW Excel/_NOV _Q2_191 DC.xlsx',
                               data_only=True)
            sheet = wb.get_sheet_by_name('Global Template')
            max_col = (sheet.max_column)
            max_row = (sheet.max_row) + 1
                                            ...
                                            if value != None:
                                                ...
                                                if int(value) != None:
                                                    ...
                                                    try:
                                                        ...
                                                        periodid = periodid[0][0]
                                                        # print(dwhid, periodid, reporteddate, value)
                                                        searchQuery = "select * from DWEleIDSchemaExtract where PeriodID = %s and DWCoID = %s" % (
                                                        periodid, coid)
                                                        try:
                                                            cursor.execute(searchQuery)
                                                            re = cursor.fetchall()
                                                            ...
                                                            if re == []:
                                                                print(re)
                                                                insertQuery = "insert into DWEleIDSchemaExtract (PeriodID,ReportedDateID,DWCoID) values(%s,%s,%s)" % (
                                                                    periodid, reporteddate, coid,)
                                                                try:
                                                                    cursor.execute(insertQuery)
                                                                    connection.commit()
                                                                    print("query executed")
                                                                    updateQuery = "Update DWEleIDSchemaExtract set `%s` = %s where PeriodID = %s and ReportedDateID = %s and DWCoID = %s " % (
                                                                        str(dwhid), value, periodid, reporteddate, coid)
                                                                    try:
                                                                        cursor.execute(updateQuery)
                                                                        print("executed after inserted")
                                                                        connection.commit()
                                                                    except Exception as e:
                                                                        print(e)
                                                                except Exception as e:
                                                                ...
                                                                print(re)
                                                                searchQuery = "select * from DWEleIDSchemaExtract where PeriodID = %s and DWCoID = %s and `%s` IS NOT NULL" % (
                                                                    periodid, coid,str(dwhid))
                                                                try:
                                                                    cursor.execute(searchQuery)
                                                                    refound = cursor.fetchall()
                                                                    if refound == []:
                                                                        updateQuery = "Update DWEleIDSchemaExtract set `%s` = %s where PeriodID = %s and ReportedDateID = %s and DWCoID = %s " % (
                                                                            str(dwhid), value, periodid, reporteddate,
                                                                            coid)
                                                                        try:
                                                                            cursor.execute(updateQuery)
                                                                            print("executed")
                                                            ...
                                                            if re == []:
                                                                ...
                                                                # if (dwhid == str(121)):
                                                                    ...
                                                                    try:
                                                                        ...
                                                                        try:
                                                                            cursor.execute(updateQuery)
                                                                            print(periodid,value,"executed after inserted")
                                                                            connection.commit()
                                                                    ...
                                                                    searchQuery = "select DWID from DWPeriodSchemaExtract where DWID = %s and DWCoID = %s and `%s` IS NOT NULL" % (
                                                                    dwhid, coid,periodid)
                                                                    try:
                                                                        cursor.execute(searchQuery)
                                                                        refound = cursor.fetchall()
                                                                        if refound == []:
                                                                            print(dwhid, value, periodid)
                                                                            updateQuery = "Update DWPeriodSchemaExtract set `%s` = %s where DWID = %s and ReportedDateID = %s and DWCoID = %s " % (
                                                                                str(periodid), value, dwhid, reporteddate,
                                                                                coid)
                                                                            try:
                                                                                cursor.execute(updateQuery)
                                                                                print(periodid, value, "updated")
                                                                                connection.commit()
                                                                            except Exception as e:
                                                                                print(e)
                                                                        else:
                                                                            print(refound,periodid)
