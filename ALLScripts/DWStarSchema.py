                    ...
                    if (gxbrlid != 0 or gxbrlid != 'None'):
                        ...
                        try:
                            if(gxbrlvalue.isdigit() == True):
                                ...
                                try:
                                    checkifexist = "select * from DWElement where EleRefID = {}".format(\
                                                    ...
                                                    if value != None:
                                                        if int(value) != None :
                                                            ...
                                                            try:
                                                                ...
                                                                try:
                                                                    insertQuery = "insert into DWStarSchemaExtract (DWID,PeriodID,ReportedDateID,Value,DWCoID) Values(%s,%s,%s,%s,%s)"\
    ...
    try:
        ...
        if connection.is_connected():
            ...
            #     #for todays date
                ...
                coid = 9
                try:
                    DwhQuery = "select * from DWElement1"
                    cursor.execute(DwhQuery)
                    resultdwh = cursor.fetchall()
                    for val in resultdwh:
                        print(val[0])
                        try:
                            insertQuery = "insert into DWPeriodSchema1 (DWID,ReportedDateID,DWCoID) Values(%s,%s,%s)" \
                                                                                            %(val[0],reporteddate,coid)
                            cursor.execute(insertQuery)
                            connection.commit()
                        except Exception as e:
                            print(e)
                                                    ...
                                                    if value != None:
                                                        if int(value) != None :
                                                            ...
                                                            try:
                                                                ...
                                                                print(dwhid, periodid, reporteddate,value,coid)
                                                                try:
                                                                    UpdateQuery = "Update DWPeriodSchema1 set `%s` = %s where DWID = %s and DWCoID = %s"%(periodid,value,dwhid,coid)
                                                                    cursor.execute(UpdateQuery)
                                                                    connection.commit()
                                                                    print("updated successfully")
                                                                except Exception as e:
                                                                    print("update values", e)
