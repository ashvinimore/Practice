    ...
    try:
        ...
        if connection.is_connected():
            ...
            for periodyear in periodss:
                selectQuery = "select PeriodId,PeriodYear,ModeID,PeriodIDx from CalendarPeriod where PeriodYear = %s"%(periodyear)
                ...
                for re in result :
                    ...
                    try:
                        UpdateQuery  = "update CalendarPeriod set PeriodIDPri = %s where PeriodID = %s"%(periodidpri,str(re[0]))
